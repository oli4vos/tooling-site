...
import { calculateActueleHypotheekrente } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateActueleHypotheekrente> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateActueleHypotheekrente(parsed));
          } catch {
            setOutput(null);
