...
import { calculateHypotheekMaandlastenNaRentewijziging } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHypotheekMaandlastenNaRentewijziging> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHypotheekMaandlastenNaRentewijziging(parsed));
          } catch {
            setOutput(null);
