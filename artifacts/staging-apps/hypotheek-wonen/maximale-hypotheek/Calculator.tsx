...
import { calculateMaximaleHypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleHypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleHypotheek(parsed));
          } catch {
            setOutput(null);
