...
import { calculateFamiliebankHypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateFamiliebankHypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateFamiliebankHypotheek(parsed));
          } catch {
            setOutput(null);
