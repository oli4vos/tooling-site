...
import { calculateHypotheekOversluiten } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHypotheekOversluiten> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHypotheekOversluiten(parsed));
          } catch {
            setOutput(null);
