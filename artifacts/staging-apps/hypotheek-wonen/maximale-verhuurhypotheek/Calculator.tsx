...
import { calculateMaximaleVerhuurhypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleVerhuurhypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleVerhuurhypotheek(parsed));
          } catch {
            setOutput(null);
