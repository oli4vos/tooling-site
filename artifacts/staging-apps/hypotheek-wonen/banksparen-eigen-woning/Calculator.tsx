...
import { calculateBanksparenEigenWoning } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateBanksparenEigenWoning> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateBanksparenEigenWoning(parsed));
          } catch {
            setOutput(null);
