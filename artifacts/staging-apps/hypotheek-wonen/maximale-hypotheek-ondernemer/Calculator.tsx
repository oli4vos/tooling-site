...
import { calculateMaximaleHypotheekOndernemer } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleHypotheekOndernemer> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleHypotheekOndernemer(parsed));
          } catch {
            setOutput(null);
