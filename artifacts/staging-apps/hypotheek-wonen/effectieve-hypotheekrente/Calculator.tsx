...
import { calculateEffectieveHypotheekrente } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateEffectieveHypotheekrente> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateEffectieveHypotheekrente(parsed));
          } catch {
            setOutput(null);
