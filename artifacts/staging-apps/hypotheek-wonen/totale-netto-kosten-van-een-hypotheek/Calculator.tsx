...
import { calculateTotaleNettoKostenVanEenHypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateTotaleNettoKostenVanEenHypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateTotaleNettoKostenVanEenHypotheek(parsed));
          } catch {
            setOutput(null);
