...
import { calculateKostenHypotheekvormen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateKostenHypotheekvormen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateKostenHypotheekvormen(parsed));
          } catch {
            setOutput(null);
