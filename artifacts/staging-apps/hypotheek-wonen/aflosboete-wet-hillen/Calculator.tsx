...
import { calculateAflosboeteWetHillen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateAflosboeteWetHillen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateAflosboeteWetHillen(parsed));
          } catch {
            setOutput(null);
