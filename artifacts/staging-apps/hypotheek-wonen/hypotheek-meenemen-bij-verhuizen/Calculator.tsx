...
import { calculateHypotheekMeenemenBijVerhuizen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHypotheekMeenemenBijVerhuizen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHypotheekMeenemenBijVerhuizen(parsed));
          } catch {
            setOutput(null);
