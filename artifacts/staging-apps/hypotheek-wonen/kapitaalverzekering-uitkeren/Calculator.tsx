...
import { calculateKapitaalverzekeringUitkeren } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateKapitaalverzekeringUitkeren> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateKapitaalverzekeringUitkeren(parsed));
          } catch {
            setOutput(null);
