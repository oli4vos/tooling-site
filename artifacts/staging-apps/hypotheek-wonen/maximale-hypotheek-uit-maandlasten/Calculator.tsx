...
import { calculateMaximaleHypotheekUitMaandlasten } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleHypotheekUitMaandlasten> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleHypotheekUitMaandlasten(parsed));
          } catch {
            setOutput(null);
