...
import { calculateHypotheekUitEigenBv } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHypotheekUitEigenBv> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHypotheekUitEigenBv(parsed));
          } catch {
            setOutput(null);
