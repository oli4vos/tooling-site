...
import { calculateAflossingseisHypotheekrenteaftrek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateAflossingseisHypotheekrenteaftrek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateAflossingseisHypotheekrenteaftrek(parsed));
          } catch {
            setOutput(null);
