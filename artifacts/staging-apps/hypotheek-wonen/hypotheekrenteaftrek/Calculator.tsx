...
import { calculateHypotheekrenteaftrek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHypotheekrenteaftrek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHypotheekrenteaftrek(parsed));
          } catch {
            setOutput(null);
