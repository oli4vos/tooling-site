...
import { calculateRestschuldBerekenenAflossen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateRestschuldBerekenenAflossen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateRestschuldBerekenenAflossen(parsed));
          } catch {
            setOutput(null);
