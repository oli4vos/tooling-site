...
import { calculateMaximaleHypotheekNaVerhuizen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleHypotheekNaVerhuizen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleHypotheekNaVerhuizen(parsed));
          } catch {
            setOutput(null);
