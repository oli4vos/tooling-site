...
import { calculateHypotheekrenteVooruitBetalen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHypotheekrenteVooruitBetalen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHypotheekrenteVooruitBetalen(parsed));
          } catch {
            setOutput(null);
