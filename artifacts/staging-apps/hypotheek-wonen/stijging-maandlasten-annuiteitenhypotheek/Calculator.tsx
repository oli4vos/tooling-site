...
import { calculateStijgingMaandlastenAnnuiteitenhypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateStijgingMaandlastenAnnuiteitenhypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateStijgingMaandlastenAnnuiteitenhypotheek(parsed));
          } catch {
            setOutput(null);
