...
import { calculateMaximaleErfpachtHypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleErfpachtHypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleErfpachtHypotheek(parsed));
          } catch {
            setOutput(null);
