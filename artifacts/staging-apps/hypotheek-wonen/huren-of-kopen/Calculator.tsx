...
import { calculateHurenOfKopen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHurenOfKopen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHurenOfKopen(parsed));
          } catch {
            setOutput(null);
