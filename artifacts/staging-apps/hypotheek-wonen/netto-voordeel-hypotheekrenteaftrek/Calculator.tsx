...
import { calculateNettoVoordeelHypotheekrenteaftrek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateNettoVoordeelHypotheekrenteaftrek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateNettoVoordeelHypotheekrenteaftrek(parsed));
          } catch {
            setOutput(null);
