...
import { calculateMaandlastenAnnuiteitenhypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaandlastenAnnuiteitenhypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaandlastenAnnuiteitenhypotheek(parsed));
          } catch {
            setOutput(null);
