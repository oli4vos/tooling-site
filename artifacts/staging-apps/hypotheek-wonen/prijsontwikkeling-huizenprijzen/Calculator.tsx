...
import { calculatePrijsontwikkelingHuizenprijzen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculatePrijsontwikkelingHuizenprijzen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculatePrijsontwikkelingHuizenprijzen(parsed));
          } catch {
            setOutput(null);
