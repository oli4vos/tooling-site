...
import { calculateHogereMaximaleHypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHogereMaximaleHypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHogereMaximaleHypotheek(parsed));
          } catch {
            setOutput(null);
