...
import { calculateMaandlastenLineaireHypotheek } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaandlastenLineaireHypotheek> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaandlastenLineaireHypotheek(parsed));
          } catch {
            setOutput(null);
