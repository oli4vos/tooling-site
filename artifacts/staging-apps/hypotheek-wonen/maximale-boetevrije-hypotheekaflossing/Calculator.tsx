...
import { calculateMaximaleBoetevrijeHypotheekaflossing } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaximaleBoetevrijeHypotheekaflossing> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaximaleBoetevrijeHypotheekaflossing(parsed));
          } catch {
            setOutput(null);
