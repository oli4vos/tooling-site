...
import { calculateBoeterenteBerekenen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateBoeterenteBerekenen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateBoeterenteBerekenen(parsed));
          } catch {
            setOutput(null);
