...
import { calculateNettoHypotheekMaandlasten } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateNettoHypotheekMaandlasten> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateNettoHypotheekMaandlasten(parsed));
          } catch {
            setOutput(null);
