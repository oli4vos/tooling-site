...
import { calculateEigenwoningforfait } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateEigenwoningforfait> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateEigenwoningforfait(parsed));
          } catch {
            setOutput(null);
