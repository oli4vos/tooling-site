...
import { calculateAftrekbareHypotheekrenteBerekenen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateAftrekbareHypotheekrenteBerekenen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateAftrekbareHypotheekrenteBerekenen(parsed));
          } catch {
            setOutput(null);
