...
import { calculateHoeveelEigenGeldHeeftUNodig } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHoeveelEigenGeldHeeftUNodig> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHoeveelEigenGeldHeeftUNodig(parsed));
          } catch {
            setOutput(null);
