...
import { calculateHuisOnderWaterAflossen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateHuisOnderWaterAflossen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateHuisOnderWaterAflossen(parsed));
          } catch {
            setOutput(null);
