...
import { calculateAflossingsvrijeHypotheekTussentijdsAflossen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateAflossingsvrijeHypotheekTussentijdsAflossen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateAflossingsvrijeHypotheekTussentijdsAflossen(parsed));
          } catch {
            setOutput(null);
