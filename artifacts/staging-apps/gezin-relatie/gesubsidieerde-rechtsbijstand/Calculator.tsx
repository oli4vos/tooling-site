...
import { calculateGesubsidieerdeRechtsbijstand } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateGesubsidieerdeRechtsbijstand> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateGesubsidieerdeRechtsbijstand(parsed));
          } catch {
            setOutput(null);
