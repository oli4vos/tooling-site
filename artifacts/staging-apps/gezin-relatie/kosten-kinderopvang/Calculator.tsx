...
import { calculateKostenKinderopvang } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateKostenKinderopvang> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateKostenKinderopvang(parsed));
          } catch {
            setOutput(null);
