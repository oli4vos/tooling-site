...
import { calculateBetaaldOuderschapsverlof } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateBetaaldOuderschapsverlof> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateBetaaldOuderschapsverlof(parsed));
          } catch {
            setOutput(null);
