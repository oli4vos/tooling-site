...
import { calculateKinderbijslagBerekenen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateKinderbijslagBerekenen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateKinderbijslagBerekenen(parsed));
          } catch {
            setOutput(null);
