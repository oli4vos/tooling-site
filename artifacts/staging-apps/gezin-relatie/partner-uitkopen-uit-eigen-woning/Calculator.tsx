...
import { calculatePartnerUitkopenUitEigenWoning } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculatePartnerUitkopenUitEigenWoning> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculatePartnerUitkopenUitEigenWoning(parsed));
          } catch {
            setOutput(null);
