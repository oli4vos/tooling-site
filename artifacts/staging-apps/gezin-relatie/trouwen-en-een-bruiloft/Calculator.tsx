...
import { calculateTrouwenEnEenBruiloft } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateTrouwenEnEenBruiloft> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateTrouwenEnEenBruiloft(parsed));
          } catch {
            setOutput(null);
