...
import { calculateVergoedingsrechtBinnenEenHuwelijk } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateVergoedingsrechtBinnenEenHuwelijk> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateVergoedingsrechtBinnenEenHuwelijk(parsed));
          } catch {
            setOutput(null);
