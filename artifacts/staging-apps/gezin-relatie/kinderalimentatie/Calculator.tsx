...
import { calculateKinderalimentatie } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateKinderalimentatie> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateKinderalimentatie(parsed));
          } catch {
            setOutput(null);
