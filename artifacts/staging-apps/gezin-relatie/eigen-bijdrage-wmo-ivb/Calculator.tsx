...
import { calculateEigenBijdrageWmoIvb } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateEigenBijdrageWmoIvb> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateEigenBijdrageWmoIvb(parsed));
          } catch {
            setOutput(null);
