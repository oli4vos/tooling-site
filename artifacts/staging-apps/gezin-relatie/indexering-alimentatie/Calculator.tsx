...
import { calculateIndexeringAlimentatie } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateIndexeringAlimentatie> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateIndexeringAlimentatie(parsed));
          } catch {
            setOutput(null);
