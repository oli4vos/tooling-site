...
import { calculateWaardebepalingViaCashflowDcfMethode } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateWaardebepalingViaCashflowDcfMethode> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateWaardebepalingViaCashflowDcfMethode(parsed));
          } catch {
            setOutput(null);
