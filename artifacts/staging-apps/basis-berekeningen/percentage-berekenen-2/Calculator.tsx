...
import { calculatePercentageBerekenen2 } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculatePercentageBerekenen2> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculatePercentageBerekenen2(parsed));
          } catch {
            setOutput(null);
