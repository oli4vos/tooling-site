...
import { calculateAnnuitairGeleendBedrag } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateAnnuitairGeleendBedrag> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateAnnuitairGeleendBedrag(parsed));
          } catch {
            setOutput(null);
