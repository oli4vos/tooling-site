...
import { calculateLineaireLeningAflossen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateLineaireLeningAflossen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateLineaireLeningAflossen(parsed));
          } catch {
            setOutput(null);
