...
import { calculatePercentageBerekenen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculatePercentageBerekenen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculatePercentageBerekenen(parsed));
          } catch {
            setOutput(null);
