...
import { calculateGemiddeldeCijfer } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateGemiddeldeCijfer> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateGemiddeldeCijfer(parsed));
          } catch {
            setOutput(null);
