...
import { calculateContanteWaardeVoorEenReeksBetalingen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateContanteWaardeVoorEenReeksBetalingen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateContanteWaardeVoorEenReeksBetalingen(parsed));
          } catch {
            setOutput(null);
