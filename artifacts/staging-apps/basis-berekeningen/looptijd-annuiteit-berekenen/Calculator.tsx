...
import { calculateLooptijdAnnuiteitBerekenen } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateLooptijdAnnuiteitBerekenen> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateLooptijdAnnuiteitBerekenen(parsed));
          } catch {
            setOutput(null);
