...
import { calculateEnkelvoudigeRente } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateEnkelvoudigeRente> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateEnkelvoudigeRente(parsed));
          } catch {
            setOutput(null);
