...
import { calculateRomeinseCijfers } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateRomeinseCijfers> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateRomeinseCijfers(parsed));
          } catch {
            setOutput(null);
