...
import { calculateGewogenGemiddeldeRentepercentage } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateGewogenGemiddeldeRentepercentage> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateGewogenGemiddeldeRentepercentage(parsed));
          } catch {
            setOutput(null);
