...
import { calculateLeasetermijnFinancialLease } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateLeasetermijnFinancialLease> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateLeasetermijnFinancialLease(parsed));
          } catch {
            setOutput(null);
