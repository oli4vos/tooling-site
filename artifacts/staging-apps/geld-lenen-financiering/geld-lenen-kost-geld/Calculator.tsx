...
import { calculateGeldLenenKostGeld } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateGeldLenenKostGeld> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateGeldLenenKostGeld(parsed));
          } catch {
            setOutput(null);
