...
import { calculateRestschuldBijFinancialLease } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateRestschuldBijFinancialLease> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateRestschuldBijFinancialLease(parsed));
          } catch {
            setOutput(null);
