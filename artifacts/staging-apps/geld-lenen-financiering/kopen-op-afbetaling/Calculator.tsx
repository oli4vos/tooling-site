...
import { calculateKopenOpAfbetaling } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateKopenOpAfbetaling> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateKopenOpAfbetaling(parsed));
          } catch {
            setOutput(null);
