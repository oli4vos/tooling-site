...
import { calculateRenteBijLening } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateRenteBijLening> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateRenteBijLening(parsed));
          } catch {
            setOutput(null);
