...
import { calculatePersoonlijkeLeningVergelijken } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculatePersoonlijkeLeningVergelijken> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculatePersoonlijkeLeningVergelijken(parsed));
          } catch {
            setOutput(null);
