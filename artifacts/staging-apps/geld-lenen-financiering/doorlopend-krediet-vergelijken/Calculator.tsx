...
import { calculateDoorlopendKredietVergelijken } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateDoorlopendKredietVergelijken> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateDoorlopendKredietVergelijken(parsed));
          } catch {
            setOutput(null);
