...
import { calculateMaandbedragVoorAflossingLening } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateMaandbedragVoorAflossingLening> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateMaandbedragVoorAflossingLening(parsed));
          } catch {
            setOutput(null);
