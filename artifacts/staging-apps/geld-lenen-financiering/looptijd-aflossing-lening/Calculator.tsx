...
import { calculateLooptijdAflossingLening } from "./logic";
...
export default function Calculator() {
  ...
  const [output, setOutput] = useState<ReturnType<typeof calculateLooptijdAflossingLening> | null>(null);
      ...
      <button
        ...
        onClick={() => {
          ...
          try {
            ...
            setOutput(calculateLooptijdAflossingLening(parsed));
          } catch {
            setOutput(null);
