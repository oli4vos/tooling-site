# Migratie naar apps/netto-aow-pensioen-of-lijfrente-uitkering

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/netto-aow-pensioen-of-lijfrente-uitkering/app.json` met `app.json.template`.
