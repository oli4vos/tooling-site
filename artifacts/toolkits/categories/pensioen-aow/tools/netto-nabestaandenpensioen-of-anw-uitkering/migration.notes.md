# Migratie naar apps/netto-nabestaandenpensioen-of-anw-uitkering

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/netto-nabestaandenpensioen-of-anw-uitkering/app.json` met `app.json.template`.
