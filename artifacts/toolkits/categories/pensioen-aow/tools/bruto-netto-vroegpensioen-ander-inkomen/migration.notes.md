# Migratie naar apps/bruto-netto-vroegpensioen-ander-inkomen

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/bruto-netto-vroegpensioen-ander-inkomen/app.json` met `app.json.template`.
