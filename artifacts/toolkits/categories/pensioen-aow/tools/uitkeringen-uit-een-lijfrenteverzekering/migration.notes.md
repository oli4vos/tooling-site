# Migratie naar apps/uitkeringen-uit-een-lijfrenteverzekering

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/uitkeringen-uit-een-lijfrenteverzekering/app.json` met `app.json.template`.
