# Migratie naar apps/contante-waarde-voor-een-reeks-betalingen

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/contante-waarde-voor-een-reeks-betalingen/app.json` met `app.json.template`.
