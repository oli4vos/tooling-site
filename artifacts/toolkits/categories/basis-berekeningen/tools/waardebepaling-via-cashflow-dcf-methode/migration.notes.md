# Migratie naar apps/waardebepaling-via-cashflow-dcf-methode

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/waardebepaling-via-cashflow-dcf-methode/app.json` met `app.json.template`.
