# Migratie naar apps/mkb-winstvrijstelling-en-ondernemersaftrek

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/mkb-winstvrijstelling-en-ondernemersaftrek/app.json` met `app.json.template`.
