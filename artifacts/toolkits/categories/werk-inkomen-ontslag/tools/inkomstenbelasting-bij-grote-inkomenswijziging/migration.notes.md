# Migratie naar apps/inkomstenbelasting-bij-grote-inkomenswijziging

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/inkomstenbelasting-bij-grote-inkomenswijziging/app.json` met `app.json.template`.
