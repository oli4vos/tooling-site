# Migratie naar apps/tariefsaanpassing-aftrek-kosten-eigen-woning

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/tariefsaanpassing-aftrek-kosten-eigen-woning/app.json` met `app.json.template`.
