# Migratie naar apps/aflossingsvrije-hypotheek-tussentijds-aflossen

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/aflossingsvrije-hypotheek-tussentijds-aflossen/app.json` met `app.json.template`.
