# Migratie naar apps/stijging-maandlasten-annuiteitenhypotheek

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/stijging-maandlasten-annuiteitenhypotheek/app.json` met `app.json.template`.
