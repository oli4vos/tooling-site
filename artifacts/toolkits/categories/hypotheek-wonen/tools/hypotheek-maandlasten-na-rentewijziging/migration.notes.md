# Migratie naar apps/hypotheek-maandlasten-na-rentewijziging

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/hypotheek-maandlasten-na-rentewijziging/app.json` met `app.json.template`.
