# Migratie naar apps/hypotheek-aflossen-in-plaats-van-sparen

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/hypotheek-aflossen-in-plaats-van-sparen/app.json` met `app.json.template`.
