# Migratie naar apps/vermogenswinstbelasting-en-vermogensaanwasbelasting

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/vermogenswinstbelasting-en-vermogensaanwasbelasting/app.json` met `app.json.template`.
