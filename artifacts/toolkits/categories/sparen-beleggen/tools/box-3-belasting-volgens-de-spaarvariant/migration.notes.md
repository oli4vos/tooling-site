# Migratie naar apps/box-3-belasting-volgens-de-spaarvariant

1. Kopieer deze mapinhoud als input voor implementatie.
2. Maak of update `apps/box-3-belasting-volgens-de-spaarvariant/app.json` met `app.json.template`.
