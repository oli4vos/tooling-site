...
export const SOURCE_DATASET_REGISTRY: readonly SourceDataset[] = [
  ...
  {
    family: "tax-box1-rates",
    scenario: "under-aow-age",
    meta: {
      recordType: "dataset",
      id: "tax-box1-rates-2026-under-aow-age",
      title: "Box 1-tarieven 2026 vóór AOW-leeftijd",
      year: 2026,
      version: "1.0.0",
      effectiveFrom: "2026-01-01",
      effectiveTo: "2026-12-31",
      ...
      sourceType: "official-execution",
      methodology:
        "Officiële box 1-schijfgrenzen en tarieven voor belastingplichtigen die in 2026 de AOW-leeftijd nog niet hebben bereikt; heffingskortingen zijn geen onderdeel van deze dataset.",
      methodologyType: "official-norm",
      notes:
        "Gebruikt als tariefreferentie. Persoonlijke heffingskortingen, aftrekposten en ondernemersregelingen worden apart beoordeeld.",
      status: "active",
    },
  ...
  },
  {
    ...
    meta: {
      recordType: "dataset",
      id: "tax-box3-provisional-2026",
      title: "Voorlopige forfaitaire box 3-berekening 2026",
      year: 2026,
      version: "1.0.0",
      effectiveFrom: "2026-01-01",
      effectiveTo: "2026-12-31",
      ...
      sourceType: "official-execution",
      methodology:
        "Voorlopige forfaitaire box 3-berekening 2026 met afzonderlijke rendementspercentages, heffingsvrij vermogen, schuldendrempel en belastingtarief volgens de uitleg van de Belastingdienst.",
      methodologyType: "official-norm",
      notes:
        "Percentages voor banktegoeden en schulden zijn voorlopig. De officiële methode voor werkelijk rendement valt buiten deze dataset.",
      status: "active",
    },
