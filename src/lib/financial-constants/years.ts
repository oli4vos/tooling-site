      ...
      box1: {
        ...
        credits: {
          meta: {
            ...
            validFrom: "2026-01-01",
            validUntil: "2026-12-31",
            appliesTo: "Landelijke heffingskortingen voor box 1; persoonlijke voorwaarden blijven een invoervraag.",
            ruleType: "uitvoeringsbeleid",
            uncertainties: "Arbeidskorting bevat meerdere inkomensfasen; de waarden zijn centraal vastgelegd als jaarparameter voor 2026.",
          },
          general: { max: 311500, start: 2973600, reductionRate: 63980 },
          generalAow: { max: 155600, start: 2973600, reductionRate: 31950 },
          labour: {
            limits: [1196500, 2584500, 4559200],
            rates: [83240, 310090, 19500, 65100],
            bases: [0, 99600, 530000, 568500],
            aowRates: [41560, 154830, 9740, 32500],
            aowBases: [0, 49800, 264700, 284000],
          },
          elderly: { max: 206700, start: 4600200 },
          singleElderly: 54000,
          iack: { max: 303200, start: 623900 },
          disabled: 92300,
        },
      },
      zvw: {
        meta: {
          sourceLabel: "Belastingdienst inkomensafhankelijke bijdrage Zvw 2026",
          lastChecked: "2026-09-23",
          status: "definitief",
          ...
          validFrom: "2026-01-01",
          validUntil: "2026-12-31",
          appliesTo: "Werkgeversheffing en eigen bijdrage over het gemaximeerde bijdrage-inkomen.",
          ruleType: "uitvoeringsbeleid",
        },
        employerRate: 6.10,
        employeeRate: 4.85,
        selfEmployedRate: 4.85,
